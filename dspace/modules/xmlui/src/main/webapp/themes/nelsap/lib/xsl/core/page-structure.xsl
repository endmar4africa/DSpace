            ...
            <div id="ds-header" class="clearfix">
                <a id="ds-header-logo-link">
                    ...
                    <span id="ds-header-logo-text">
                       <i18n:text>Knowledge Repository</i18n:text>
                    </span>
                  </a>
        ...
        <div id="ds-footer-wrapper">
            <div id="ds-footer">
                <div id="ds-footer-left">
                    <a href="http://entro.nilebasin.org/" target="_blank">Go to ENTRO Portal</a>
                </div>
                <div id="ds-footer-right">
                    <span class="theme-by">©2019 ENTRO&#160;</span>
                  <a href="/page/disclaimer">Disclaimer</a>  <xsl:text> | </xsl:text>
                  <a href="page/pirvacypolicy">Privacy Policy</a> <xsl:text> | </xsl:text>
    ...
    <xsl:template match="dri:body">
        <div id="ds-body">
            ...
            <xsl:choose>
                <xsl:when test="starts-with($request-uri, 'page/about')">
                    <div>
                        <h1>About NBI Repository</h1>
                          <p>NBI has generated transparent, unbiased and credible knowledge and information, which is available to all and
                            increasingly shared through web based platforms namely; the Nile Information System, virtual libraries, website,
                            Nile Basin Decision Support (NB-DSS) Community Portal, Nile Basin Water Resources Atlas, State of the Nile River.
                            </p>
                          <p>
                          This Institutional Repository built on <a href="http://www.dspace.org" title="DSpace homepage">DSpace</a>.
                          Dspace is continuously undergoing further development to enhance its functionality
                          in response to users’ changing information needs as well as the need to adopt new emerging technologies for better knowledge services
                          and products. The repository is interoperable with other repositories and supports discoverability and re-usability
                          of the content by complying with <a target="_blank" href="http://dublincore.org/specifications/"> Dublin Core Metadata Initiative
                          </a>(DCMI) standards.
                          This Knowledge pository uses a qualified Dublin Core metadata set that maps MARC21 metadata to Simple Dublin Core,and MODS metadata sets
                          exposed through the <a target="_blank" href="http://www.openarchives.org/"> Open Archives Initiative Protocol
                          for Metadata Harvesting (OAI-PMH) protocol.</a>
                          </p>
                          <p> One significant development of this KR is that of this KR replicates or mirrors to enable participation by the threee centers namely,
                            NILE-SEC,NELSAP-CU ,ENTRO.</p>

                          <p>The key individuals involved included:</p>
                                  <ul>
                                    <li>Azeb Mersha (ENTRO) ― instigated the repository, leads the overall effort.</li>
                                    <li>Tirsit Endashow(ENTRO) ― involved in all content management actvities and developments.</li>
                                    <li>Sisay Webshet (ILRI) ― set up the repository,</li>
                                  </ul>

                        <h2>Disclaimer</h2>
        					      <p>KR content providers and partners accept no liability to any consequence resulting from use of the content or data made available in this repository. Users of this content assume full responsibility for compliance with all relevant national or international regulations and legislation.</p>
                    </div>
                </xsl:when>

                <xsl:when test="starts-with($request-uri, 'page/help')">
                  <div>
                <h1>Testing help over page structure</h1>
               ...
               <xsl:when test="starts-with($request-uri, 'page/disclaimer')">
                 <div>
               <h1>Disclaimer</h1>
               <p>KR content providers and partners accept no liability to any consequence resulting from use of the content or data made available
                 in this repository. Users of this content assume full responsibility for compliance with all relevant national or international
                 regulations and legislation.
                </p>
                </div>
              </xsl:when>

              <xsl:when test="starts-with($request-uri, 'page/pirvacypolicy')">
                <div>
              <h1>Privacy Policy</h1>
              <p>Privacy Policy under construction......
               </p>
               </div>
             </xsl:when>

             <xsl:when test="starts-with($request-uri, 'page/termsofuse')">
               <div>
             <h1>Terms of Use</h1>
             <p>Terms of Use under construction....
              </p>
              </div>
            </xsl:when>

                 <xsl:when test="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='URI']='help'">
                    <xsl:for-each select ="document('help.xml')" />
                </xsl:when>
