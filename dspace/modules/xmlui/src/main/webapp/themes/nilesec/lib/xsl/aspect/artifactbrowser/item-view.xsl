    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 4 and (dim:field[@element='date' and @qualifier='issued' and descendant::text()])">
            ...
            <xsl:when test="$clause = 5 and (dim:field[@element='contributor' and @qualifier='affiliation' and descendant::text()])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>Affilation</i18n:text>:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='contributor' and @qualifier='affiliation']">
		                     <xsl:copy-of select="./node()"/>
                            <xsl:if test="count(following-sibling::dim:field[@element='contributor' and @qualifier='affiliation']) != 0">
		                    	<br/>
		                    </xsl:if>
	                    </xsl:for-each>
	                </span>
            ...
            <xsl:when test="$clause = 6 and (dim:field[@element='subject' and @qualifier='entro' and descendant::text()])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>Entro Subject</i18n:text>:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='subject' and @qualifier='entro']">
		                     <xsl:copy-of select="./node()"/>
                            <xsl:if test="count(following-sibling::dim:field[@element='subject' and @qualifier='entro']) != 0">
		                    	<br/>
		                    </xsl:if>
	                    </xsl:for-each>
	                </span>
           ...
           <xsl:when test="$clause = 7 and (dim:field[@element='sub' and @qualifier='basin' and descendant::text()])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>Sub basin</i18n:text>:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='sub' and @qualifier='basin']">
		                     <xsl:copy-of select="./node()"/>
                            <xsl:if test="count(following-sibling::dim:field[@element='sub' and @qualifier='basin']) != 0">
		                    	<br/>
		                    </xsl:if>
	                    </xsl:for-each>
	                </span>
        ...
        <xsl:when test="$clause = 8 and (dim:field[@element='identifier' and @qualifier='status' and descendant::text()])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>Status</i18n:text>:</span>
	                <span>
        ...
        <xsl:when test="$clause = 9 and (dim:field[@element='coverage' and @qualifier='country' and descendant::text()])">
                    <div class="simple-item-view-other">
	                <span class="bold"><i18n:text>Countries</i18n:text>:</span>
	                <span>
	                	<xsl:for-each select="dim:field[@element='coverage' and @qualifier='country']">
		                     <xsl:copy-of select="./node()"/>
                            <xsl:if test="count(following-sibling::dim:field[@element='coverage' and @qualifier='country']) != 0">
		                    	<br/>
		                    </xsl:if>
	                    </xsl:for-each>
	                </span>
      ...
      <!-- Type row -->
		 <xsl:when test="$clause = 10 and (dim:field[@element='type' and not(@qualifier)])">
         ...
         <xsl:if test="count(dim:field[@element='type' and not(@qualifier)]) &gt; 1 and not(count(dim:field[@element='type' and @qualifier='type']) &gt; 1)">
          ...
          <!-- Abstract row -->
          <xsl:when test="$clause = 11 and (dim:field[@element='description' and @qualifier='abstract' and descendant::text()])">
          ...
          <!-- Description row -->
          <xsl:when test="$clause = 12 and (dim:field[@element='description' and not(@qualifier) and descendant::text()])">
                <div class="simple-item-view-description">
